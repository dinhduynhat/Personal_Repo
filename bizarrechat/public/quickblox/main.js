...
$(document).ready(function() {
  ...
  QB.createSession(function(err,result){
	...
	localStorage.setItem('quickbloxapitoken', result.token);
	console.log('end');
  });
  ...
  $('#sign_up').on('click', function() {
    var login = $('#register_username').val();
    ...
    var params = { 'login': login, 'password': password, 'phone' : phone, 'full_name' : fullname, 'email' : email};
