...
$app_id				= '1487150151594094';  //localhost
$app_secret 		= 'd21402a7769810f33c28af618144467a';
$required_scope 	= 'public_profile, publish_actions'; //Permissions required
$redirect_url 		= 'http://www.sysaxiom.com/test/fb'; //FB redirects to this page with a code

//MySqli details for saving user details
$mysql_host			= 'localhost';
$mysql_username		= 'sysaxiom_sa';
$mysql_password		= 'Allaudeen@#000';
$mysql_db_name		= 'sysaxiom_db';
